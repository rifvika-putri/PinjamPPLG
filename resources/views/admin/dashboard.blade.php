...
<div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
    <div class="flex justify-between items-start">
        <div>
            <p class="text-sm text-gray-400 font-medium">Total Petugas</p>
            <h3 class="text-2xl font-bold text-[#272b34] mt-1">{{ $jumlahPetugas }}</h3>
        </div>
        <div class="p-3 bg-blue-50 rounded-2xl text-blue-500">
            <i data-lucide="package" class="w-6 h-6"></i>
        </div>
    ...
    <div class="mt-4 pt-4 border-t border-gray-50">
        <a href="{{ route('petugas.index') }}" class="text-blue-500 text-[10px] font-extrabold hover:underline flex items-center">
            MANAJEMEN PETUGAS <i data-lucide="chevron-right" class="w-3 h-3 ml-1"></i>
        </a>
    </div>
</div>
